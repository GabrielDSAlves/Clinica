...
namespace ProjetoClinico
{
    public class Paciente
    {
        ...
        public Paciente(string nome, string cpf, string dataNascimento, string cidade, string endereco, string numero, string bairro, string email, string telefone)
        {
            Nome = nome;
            Cpf = cpf;
        ...
        public Paciente(int id, string nome, string cpf, string dataNascimento, string cidade, string endereco, string numero, string bairro, string email, string telefone)
        { 
            _id = id;
            Nome = nome;
            Cpf = cpf;
